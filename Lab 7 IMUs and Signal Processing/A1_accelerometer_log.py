...
# Goal:
# Task A1 - log accelerometer data and computed roll & pitch
...
def data_recording():
    ...
    # Record 30 seconds of accelerometer data at 200 Hz
    # Compute + Log Roll and Pitch
    # Log to CSV
    
    fs = 200 # Hz
    dt = 1.0 / fs
    with open("accel_log.csv", "w") as f:
        f.write("t_ms,ax_mg,ay_mg,az_mg,roll_acc_deg,pitch_acc_deg\n")
        t0 = time.ticks_ms()
